...
"""
Полиномиальные характеристики для полей Галуа (x^8 + x^7 + x^6 + x + 1)
Порождающий полином является неприводимым, делится без остатка на 1 и на себя
"""
_GF: tuple = ((
...
_S_BOX_REVERSE_KUZNYECHIK: tuple = (
